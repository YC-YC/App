...
public class T {
	...
	public static final int STEP_MODE_TIME = 3*1000;	//步进总计时时间3S
	public static final int STEP_MODE_DIFF = 3*100;		//步进上、下值300ms
	
	public static final int SCAN_MODE_TIME = 5*1000;	//扫描单项总时间5S
	public static final int SCAN_MODE_DIFF = 5*100;		//扫描单项闪烁时间500ms
	
	
	public static final int LIST_COUNT = 6;		//列表个数
	
	public static final String RADIO_INFO_FILE = "radioinfo";		//配置文件名
	...
	public static long mLastLongClickTime = 0;	//最后按下时间
	
	public static boolean mScanMode = false;	//浏览模式
	public static int mScanItem = 0;		//浏览项
	public static boolean mScanItemSel = false;	//浏览项选中
	public static long mStartScanItemTime = 0;	//开始浏览单项时间
	
	public static int mSearchHadFreqNum = 0;	//搜台数
	public static int mSearchHadFreq = 0;	//搜台有效频率
	/**
	 * 搜台标记，区分上下搜台
	 */
	public static boolean mSearchReq = false;	//搜台标记
	...
	//BIT位为1代表有效
		public static final int KEYBOARD_EFFECTIVE_189 = 0x302; //11,0000,0010,189����
